...
@Rem copy detecteff.exe to c://windows/system32
echo Install Script initized.
echo installing detecteff as detectf for terminal
echo.
echo [COPY]
xcopy /R /Y %~dp0\\detectf.exe C:\\Windows\\System32
